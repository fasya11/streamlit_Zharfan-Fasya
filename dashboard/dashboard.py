...
# import dataframe
day_df = pd.read_csv('dashboard/day_modif_df.csv')
hour_df = pd.read_csv('dashboard/hour_modif_df.csv')
season_df = pd.read_csv('dashboard/melt_season_df.csv')
weather_df = pd.read_csv('dashboard/melt_weathersit_df.csv')
